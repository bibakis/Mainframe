...
<head>
	...
	<?php $this->load->css('libs/mainframe.css/mainframe-grid.css');?>
	<?php $this->load->css('libs/mainframe.css/mainframe-main.css');?>
	<?php $this->load->css('themes/demo/css/styles.css');?>
	<?php $this->load->js('libs/jquery-1.6.4.min.js');?>
