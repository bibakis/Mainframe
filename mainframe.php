...
// Load the Mainframe Controller
require_once COMMONPATH.'core/Mainframe_Controller.php';

// Load the local application controller
// Note: The Router class automatically validates the controller path using the router->_validate_request().
// If this include fails it means that the default controller in the Routes.php file is not resolving to something valid.

// NOTE -- Change from CodeIgniter.php to mainframe.php:
//Instead of APPPATH, the MY_Router.php method _get_base_path() is used to determine the correct path
//the controller resides in. 

if ( ! file_exists($RTR->_get_base_path().'controllers/'.$RTR->fetch_directory().$RTR->fetch_class().'.php'))
{
	show_error('Unable to load your default controller. Please make sure the controller specified in your Routes.php file is valid.');
}

include($RTR->_get_base_path().'controllers/'.$RTR->fetch_directory().$RTR->fetch_class().'.php');
